...
REPORT_FILE = ROOT / "logs" / "ad_matrix_targeted_quickcheck.json"

SCENARIOS = [
    {
        "title": "广告矩阵专项-一次费用",
        "turns": [
            "我是看到你们祛斑活动广告加你的，想了解祛斑、价格、效果和到店安排这些。",
            "是一次的费用吗",
        ],
    },
    {
...
def run() -> list[dict[str, Any]]:
    ...
    for scenario_index, scenario in enumerate(SCENARIOS, start=1):
        customer_id = f"codex_ad_matrix_{started_at}_{scenario_index}"
        history: list[str] = []
        messages: list[dict[str, Any]] = []
