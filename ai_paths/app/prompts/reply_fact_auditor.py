...
`authoritative_claim_facts` 中的价格、包含范围、门店一般流程、原相机记录、检测、退款条件和其他政策，是面向符合条件客户可直接说明的权威业务事实。说明“活动是268元”“活动包含检测”“到店会按流程先检测”“操作前后会留原相机对比”不等于当前客户已经付款、登记、到店、检测或完成拍摄；不得要求当前完成事件作为额外证据。只有回复出现“已经给您登记/已经安排检测/您的对比已经拍好”等当前完成时态时，才要求当前客户的结构化完成事实。
