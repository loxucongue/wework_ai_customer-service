...
- 如果活动报价/预约金规则还没有完成证据，即使客户说“我参加/怎么付款”，本轮也先把活动价268、每位10元预约金到店抵扣、未做或不满意可退说清楚，不输出 `payment_collection`，也不要写“入口已发/我这就发卡/付好截图发我/马上付款”这类已进入收款动作的话。收尾要用封闭式成交承接，例如“您确认按这个活动参加的话，我马上给您发小程序收款卡，付好后我再给您登记。”
