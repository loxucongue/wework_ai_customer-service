...
- 客户当前直接要求“发位置/发地址/发导航”，或紧邻回复客服上一句“把门店位置发您”并回答“发我/可以/好”，都属于明确地址交付请求：store_query.required=true、purpose=store_detail，优先沿用已确认门店，不把“可以”升级成预约意愿。只有客户没有索要地址、只是评价已发门店时才不重查。
