        ...
        "steps": {
            ...
            "地址发送": {
                ...
                "rules": [
                    ...
                    "营业时间、停车、导航必须来自工具事实。",
                    "客户明确要详细地址时，不要模糊化；默认给到市、区、路、楼/大厦即可，不主动报门头名称或具体房间号。",
                ],
        ...
        "steps": {
            "报价铺垫": {
                ...
                "rules": [
                    ...
                    "客户问效果图、案例或做完效果时查 case_studies；如果客户发图且图片备注可关联到斑点/黑色素/肤色不均等方向，可优先匹配对应案例素材。",
                    "不说案例次数和保证同样结果。",
                ],
            ...
            "报价": {
                ...
                "rules": [
                    "当前公开活动价是周年庆活动268元。",
                    "线上预约金10元，到店抵扣10元，做付258元；不放心、不满意、不来或到店不做，10元可退。",
            ...
            "逼单": {
                "goal": "对高意向客户推动预约。",
                "rules": [
                    "客户高意向或犹豫时，强调名额、活动价、预约金低门槛、到店认可再做；不放心、不满意、不来或到店不做，10元预约金可退。",
