        ...
        "AUTHORITATIVE FACTS": {
            "offer": _selected_dict_fields(
                ...
                (
                    ...
                    "face_area_price_rule",
                    "face_full_operation_boundary",
                    "multi_area_price_rule",
                    "repeat_visit_price_rule",
                    "scope_answer_policy",
                    "transport_cost_rule",
                    "quota",
                    "registration_gift",
...
def _offer_facts(offer: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "face_area_price_rule": offer.get("face_area_price_rule"),
        "face_full_operation_boundary": offer.get("face_full_operation_boundary"),
        "multi_area_price_rule": offer.get("multi_area_price_rule"),
        "repeat_visit_price_rule": offer.get("repeat_visit_price_rule"),
