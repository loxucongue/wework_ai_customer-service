...
ACTIVE_S10_OFFER_CONTEXT: dict[str, Any] = {
    ...
    "signup_rule": "仅限线上报名客户有效；线上预定10元并留电话姓名，到店抵扣10元，做付258元；客户不放心、不满意、不来或到店不做，10元预约金可退。",
    ...
    "hard_constraints": [
        ...
        "10元预约金规则：到店抵扣10，做付258；客户不放心、不满意、不来或到店不做，10元预约金可退。",
        "10元预约金只是到店抵扣，不是额外优惠、省钱、减免或立减；不要说节省10元。",
        "不要单独说10元预约金不退还；必须完整表达为到店抵扣10元、做付258元；不放心、不满意、不来或到店不做，10元预约金可退。",
    ...
    return [
        {
            **common,
            ...
            "display_price": "周年庆活动价268元，线上预约金10元，到店抵扣10元，做付258元；不放心、不满意、不来或到店不做，10元预约金可退",
...
def attach_s10_offer_facts(fact_envelope: dict[str, Any] | None) -> dict[str, Any]:
    ...
    if isinstance(usable_facts, list) and not any("周年庆活动" in str(item) for item in usable_facts):
        usable_facts.append(
            "active_offer: S10周年庆活动/抖音合作线上秒杀淡斑套餐；公开活动价268元；线上预约金10元，到店抵扣10元，做付258元；不放心、不满意、不来或到店不做，10元预约金可退；限30名；集团连锁，全国300多家门店"
        )
    return envelope
...
- 周年庆公开活动价 268 元；线上报名交 10 元预约金并留电话姓名，到店抵扣 10 元，做付 258 元；客户不放心、不满意、不来或到店不做，10 元预约金可退。
...
- 预约金口径固定说“到店抵扣10元，做付258元；不放心、不满意、不来或到店不做，10元预约金可退”；老客价没有真实订单查询结果时，不要说“我去查订单、稍等、稍后同步”。
