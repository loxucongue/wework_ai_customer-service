...
ACTIVE_S10_OFFER_CONTEXT: dict[str, Any] = {
    ...
    "hard_constraints": [
        ...
        "允许按当前权威效果口径说明绝大多数客户都是一次就好；不得扩展成所有客户一次全部去除、根治、100%见效、永久不再出现、绝对安全或包效果。",
    ],
}
...
- 客户担心一次效果或可能需要多次时，可以明确说“我们这个淡斑效果活动价就是268元，绝大多数客户都是一次就好”，再用真实效果案例建立信任；不得主动补“可能需要多次、具体看深浅和时间”等削弱信心的话，也不得扩展为所有客户一次全部去除、根治或永久不再出现。
