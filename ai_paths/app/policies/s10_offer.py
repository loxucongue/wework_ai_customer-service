...
ACTIVE_S10_OFFER_CONTEXT: dict[str, Any] = {
    ...
    "hard_constraints": [
        ...
        "老客价必须结合上一次订单金额；没有订单金额事实时，只能说明老客价需要核对上一次订单金额。",
...
def s10_price_facts() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "tail_amount": "680",
            "total_price": "680",
            "display_price": "老客上一次订单超过1000元，S10报价680元",
            "original_price": str(context["original_price"]),
            "min_quote": "680",
            "conditions": "需核对客户历史订单金额后确认",
            "rule_note": "没有订单金额事实时，不要直接判断客户老客档位。",
            "description": context["method_summary"],
        ...
        },
        {
            ...
            "tail_amount": "520",
            "total_price": "520",
            "display_price": "老客上一次订单不超过1000元，S10报价520元",
            "original_price": str(context["original_price"]),
            "min_quote": "520",
            "conditions": "需核对客户历史订单金额后确认",
            "rule_note": "没有订单金额事实时，不要直接判断客户老客档位。",
...
- 老客报价：上一次订单超过 1000 元报 680 元；上一次订单不超过 1000 元报 520 元；没有订单金额事实时，说需要核对上次订单金额。
