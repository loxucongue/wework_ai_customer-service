...
TASK_TYPE_POLICY_FAMILY_IDS = {
    ...
    "activity_inquiry": "SF7_PRICE_ACTIVITY",
    "project_inquiry": "SF3_PROJECT_CONSULT",
...
POLICIES: dict[str, dict[str, Any]] = {
    ...
    "SF3_MOLE_CAN_DO_DIRECTION": {"family": "SF3_PROJECT_CONSULT", "task_type": "project_inquiry"},
    ...
    "SF5_COMPETITOR_SCREENSHOT": {"family": "SF5_COMPETITOR_COMPARE", "task_type": "competitor_compare"},
    "SF6_STORE_CITY_ASK": {"family": "SF6_STORE_INQUIRY", "task_type": "store_inquiry"},
    ...
    "SF6_PRE_VISIT_ID_CARD": {"family": "SF6_STORE_INQUIRY", "task_type": "store_inquiry"},
    "SF7_ACTIVITY_FIRST_ASK": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    "SF7_CAMPAIGN_QUOTA_OR_END_TIME": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    ...
    "SF7_OLD_CUSTOMER_PRICE": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    "SF7_HIDDEN_FEE_WORRY": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    "SF7_TRANSPORT_SUPPORT": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    ...
    "SF7_PRICE_AD_58": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    "SF7_MOLE_PRICE_INQUIRY": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    "SF7_PACKAGE_UNCERTAINTY": {"family": "SF7_PRICE_ACTIVITY", "task_type": "price_inquiry"},
    ...
    "SF9_HESITATE_FIRST": {"family": "SF9_APPOINTMENT", "task_type": "appointment"},
    "SF9_CANCEL_SAFETY_WORRY": {"family": "SF9_APPOINTMENT_CANCEL", "task_type": "appointment_cancel"},
    ...
    "HUMAN_REQUEST_REAL_PERSON": {"family": "HUMAN_HANDOFF", "task_type": "human_request"},
...
SUBTYPE_POLICY_IDS = {
    ...
    ("project_consult", "method_compare"): "SF3_PROJECT_DETAIL_EXPLAIN",
    ("project_consult", "unsupported_need"): "SF3_PROJECT_UNSUPPORTED_NEED",
    ("project_inquiry", "need_direction"): "SF3_PROJECT_NEED_DIRECTION",
    ("project_inquiry", "project_detail"): "SF3_PROJECT_DETAIL_EXPLAIN",
    ("project_inquiry", "method_compare"): "SF3_PROJECT_DETAIL_EXPLAIN",
    ("project_inquiry", "unsupported_need"): "SF3_PROJECT_UNSUPPORTED_NEED",
    ("project_inquiry", "mole_can_do"): "SF3_MOLE_CAN_DO_DIRECTION",
    ...
    ("competitor_compare", "screenshot_compare"): "SF5_COMPETITOR_SCREENSHOT",
    ("store_inquiry", "store_city_profile"): "SF6_STORE_CITY_ASK",
    ("store_inquiry", "city_profile"): "SF6_STORE_CITY_ASK",
    ("store_inquiry", "city_ask"): "SF6_STORE_CITY_ASK",
    ...
    ("store_inquiry", "pre_visit_prepare"): "SF6_PRE_VISIT_ID_CARD",
    ("price_inquiry", "activity_first"): "SF7_ACTIVITY_FIRST_ASK",
    ("price_inquiry", "campaign_quota_or_end_time"): "SF7_CAMPAIGN_QUOTA_OR_END_TIME",
    ...
    ("price_inquiry", "old_customer_price"): "SF7_OLD_CUSTOMER_PRICE",
    ("price_inquiry", "hidden_fee_worry"): "SF7_HIDDEN_FEE_WORRY",
    ("price_inquiry", "transport_support"): "SF7_TRANSPORT_SUPPORT",
    ...
    ("price_inquiry", "ad_58"): "SF7_PRICE_AD_58",
    ("price_inquiry", "mole_price"): "SF7_MOLE_PRICE_INQUIRY",
    ("price_inquiry", "package_uncertainty"): "SF7_PACKAGE_UNCERTAINTY",
    ("activity_inquiry", "general_activity"): "SF7_ACTIVITY_FIRST_ASK",
    ("appointment", "time_check"): "SF9_APPOINTMENT_TIME_CHECK",
    ("appointment", "create_info"): "SF9_APPOINTMENT_CREATE_INFO",
    ("appointment", "hesitation"): "SF9_HESITATE_FIRST",
    ("appointment", "cancel_dissatisfaction"): "SF9_CANCEL_SAFETY_WORRY",
    ...
    ("human_request", "real_person"): "HUMAN_REQUEST_REAL_PERSON",
...
def policy_selection_from_task(primary_task: dict[str, Any], handoff: dict[str, Any] | None = None) -> dict[str, str]:
    ...
    if bool(handoff.get("needed")):
        if policy_hint in POLICIES:
            family = str((POLICIES.get(policy_hint) or {}).get("family") or "")
            if family == "HUMAN_HANDOFF":
        ...
        if policy_id and str((POLICIES.get(policy_id) or {}).get("family") or "") == "HUMAN_HANDOFF":
