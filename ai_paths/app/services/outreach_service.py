...
class OutreachService:
    ...
    async def _generate_plan_impl(
        ...
        *,
        ...
        from .outreach.plan_generation import PlanGenerator

        return await PlanGenerator(self).generate_plan(
            customer_id=customer_id,
            corp_id=corp_id,
            user_id=user_id,
            wechat=wechat,
    ...
    async def execute_task(self, task_id: str) -> dict[str, Any]:
        from .outreach.task_execution import TaskExecutor

        return await TaskExecutor(self).execute(task_id)
