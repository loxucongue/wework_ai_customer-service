...
2. 阅读最近聊天时间线：客户最后一条是否尚未被回答；客户是否明确忙碌且客服已承接等待；是否出现新的当前意图。
...
- 客户最新提出了尚未被客服或普通 AI 回答的问题；SOP 不能冒充问题答案或打断正常回复链路。
...
1. 普通沉默，平台内容仍相关且未重复：`send`。
2. 客户刚问了新问题还没人回答：`no_send`，原因写“最新客户问题待回复”。
