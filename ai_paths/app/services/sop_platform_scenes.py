...
def sop_platform_callback_scene(
    *,
    ...
    exact_mappings = {
        ...
        "no_send_explicit_stop_contact": "customer_state_blocked",
        "no_send_complaint_or_refund": "customer_state_blocked",
        "no_send_health_risk": "customer_state_blocked",
        "no_send_paid_or_appointment_conflict": "customer_state_blocked",
