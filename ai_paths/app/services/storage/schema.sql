...
VALUES
    ('S10', 'S10 淡斑套餐', '单部位体验', '第三代操作斑点技术，围绕淡斑、美白嫩肤、收缩毛孔、痘印、细纹等方向承接', '关注老年斑、遗传斑、黑色素、斑点、肤色不均等基础改善方向的客户', '孕期、哺乳期、皮肤破损或明显不适期需谨慎', '["操作斑点","检测皮肤","基础清洁","肌肤补水"]', '到店整体约50-60分钟，具体以门店安排为准', 1980);
...
VALUES
    ('S10_ANNIVERSARY_NEW_268', 'S10', 'S10 淡斑套餐', '周年庆活动价', '单部位体验', '线上报名客户', 10, 258, 268, '周年庆活动价268元，线上预约金10元，到店抵扣10元，做付258元；不做退还10元', 1980, 268, '仅限线上报名客户；限30名；套餐包括操作斑点、检测皮肤、基础清洁、肌肤补水；线下客人未预定到店按原价1980元', '当前只有周年庆活动，不得生成其他活动名'),
    ('S10_OLD_GT_1000_680', 'S10', 'S10 淡斑套餐', '老客报价', '单部位体验', '老客且系统核对上一次订单超过1000元', 0, 680, 680, '系统核对上一次订单金额后，符合老客档位时报价680元', 1980, 680, '仅用于系统内部按客户历史订单金额确认，不对客户解释阈值规则', '没有订单金额事实时，不要直接判断客户老客档位；对客户不能讲超过/不超过1000元的价格区别'),
    ('S10_OLD_LE_1000_520', 'S10', 'S10 淡斑套餐', '老客报价', '单部位体验', '老客且系统核对上一次订单不超过1000元', 0, 520, 520, '系统核对上一次订单金额后，符合老客档位时报价520元', 1980, 520, '仅用于系统内部按客户历史订单金额确认，不对客户解释阈值规则', '没有订单金额事实时，不要直接判断客户老客档位；对客户不能讲超过/不超过1000元的价格区别');
