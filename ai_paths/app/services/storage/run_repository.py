...
class RunRepositoryMixin:
    def save_run(self, *, conversation_id: str, final_state: dict[str, Any], token_usage: dict[str, Any]) -> None:
        ...
        output_snapshot = {
            ...
            "sop_stage_rules": final_state.get("sop_stage_rules", {}),
            ...
            "scene_guidance_context": final_state.get("scene_guidance_context", []),
            "active_scene_id": final_state.get("active_scene_id", ""),
            "active_scene_match_level": final_state.get("active_scene_match_level", ""),
