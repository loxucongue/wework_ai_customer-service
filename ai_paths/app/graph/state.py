...
class AgentState(TypedDict, total=False):
    ...
    cardpoint_decision: dict[str, Any]
    cardpoint_candidates: list[dict[str, Any]]
    followup_strategy_candidates: list[dict[str, Any]]
    sales_strategy_retrieval_audit: dict[str, Any]
    closing_sequence_shadow: dict[str, Any]
