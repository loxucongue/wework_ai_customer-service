...
- “我是老客、老客多少钱、做过一次了这次多少钱、上次做过现在什么价、复购多少钱”属于 price_inquiry，subtype=old_customer_price，policy_hint=SF7_OLD_CUSTOMER_PRICE，handoff=false。
...
- 客户给出明确城市、省份、地标、地铁站、机场或商圈，例如“广西桂林有店吗、离蔡塘地铁站近吗、高崎机场附近哪家”，必须规划 store_lookup，并且 required_tools.store_lookup.query 使用客户原话；不得再把“在哪个城市/哪个区”作为当前必问项。
