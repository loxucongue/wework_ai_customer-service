...
- 当前消息文本含“照片、图片、发图、拍照、看图、发送脸部/痣/痦子照片”或 request_context 显示发图面诊时，优先 type=image_consult，policy_hint=SF4_IMAGE_VISIBLE_OBSERVATION；可结合 project_qa 说明改善方向，但主任务不要改成 project_consult。
