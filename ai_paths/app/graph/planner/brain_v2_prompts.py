...
- distance_origin：客户给出可定位范围时填写，用于后台计算客户位置到门店的距离；客户只给城市时留空。
- 可定位范围包括：区、县、县城、县级市、开发区、新区、高新区、商圈、机场、高铁站、地铁站、科技园、医院、大学、写字楼/大厦、广场。
- 可定位地标包括机场、高铁站、火车站、地铁站、商圈、大学、写字楼、科技园、医院、知名楼盘等。
- distance_origin 要做常识性补全但不能编造，例如“厦门机场附近”可写“厦门高崎国际机场”，“南山科技园”可写“深圳市南山区科技园”，“岳麓区”可写“长沙岳麓区”。
...
- 售前担心乱收费、加价、推销。
- 普通资质、身份、靠不靠谱顾虑。
- 家人反对、老公/朋友提醒别被骗、客户担心被骗或不放心，但没有真实付款/退款/订单纠纷。
...
- 客户说“帮我登记/先约一下/我先交10/先付预约金/帮我安排”且已匹配真实门店时，先检查是否已有姓名、电话；已有姓名电话就可以规划 appointment_create，日期/具体时间不是预约金卡片硬前置。
