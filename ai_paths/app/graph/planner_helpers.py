...
def planner_messages_for_model(state: AgentState) -> list[dict[str, Any]]:
    system = (
        ...
        "知识库名只能是：project_qa, project_price, trust_assets, competitor_qa, after_sales_qa。"
        ...
        "客户说门店要额外加钱、收费口径不一样、怎么说不一样、退钱、把钱退给我、定金/预约金争议，属于费用或退款争议，用handoff，不要因为出现“门店/店”就用store。"
