...
from app.graph.nodes.image_info import has_image_concern, known_visible_concerns_from_state
from app.graph.nodes.legacy_flow_utils import extract_price_digits, parking_text
from app.graph.nodes.legacy_project_context import LegacyProjectContextCallbacks, contextual_price_project
...
from app.graph.nodes.legacy_skill_dispatch import LegacySkillDispatchCallbacks
...
def legacy_skill_dispatch_callbacks() -> LegacySkillDispatchCallbacks:
    return LegacySkillDispatchCallbacks(
