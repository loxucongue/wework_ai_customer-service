...
| --- | --- | --- | --- |
| 2026-09-06 | `fix-v3-store-matching` | `7b02c359` | V3 门店匹配改为以模型结构化行政语义过滤客户授权门店，城市/区县同根不再被派生地图文本缩成单店；城市/区县候选不超过 6 家全部发卡，超过 6 家改发完整“店名+区县”文字清单。30 类、310 条语义场景和全仓 277 项回归通过；真实模型验证长沙返回 4 家、长沙县返回 1 家、裸称朝阳要求消歧，已发布 `ai-paths-unified-20260906-134850-7b02c35`。 |
