...
| v3-payment-activity-latency-repair | 当前执行窗口 | `codex/v3-payment-activity-latency-repair` | `9c2c72f954d1382e08ba2e0eb25aaa838f8c722e` | V3 付款结构一致性、活动完整性上下文、Reply 热路径只读性能与对应测试；不改 MytRpc、SOP、发送协议或数据库 schema | registered |
