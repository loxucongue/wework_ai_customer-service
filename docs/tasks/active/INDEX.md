...
| --- | --- | --- | --- | --- | --- |
| customer-reception-state | 当前执行窗口 | `codex/customer-reception-state` | `e2faaccd` | 移除企业/员工/IP白名单，保留专用Token和三元接触边界；不接管现有消费者 | removing_optional_whitelists_and_issuing_token |
