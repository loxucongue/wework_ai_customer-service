...
| --- | --- | --- | --- | --- | --- |
| sop-pending-content | 当前执行窗口 | main | 0bfb6678 | SOP task service、确定性测试、SOP合同 | implementing |
| customer-reception-state | 当前执行窗口 | `codex/customer-reception-state` | `e2faaccd` | 专用Token接口已部署，无企业/员工/IP白名单；仅持久化，不接管现有消费者 | deployed_token_active_persistence_only |
