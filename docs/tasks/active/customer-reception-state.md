...
- 生产现场只读确认：`ff158e477b1b06ac2332770d51c78cf83ca6a68a`，control health正常；本任务没有部署、迁移或改动生产配置。
...
- 上线前待办：审核迁移及clean-main集成，提供专用凭证/企业范围、权威成员映射和当前verified关系，部署后联调。第二道门须明确消费者ownership、存量覆盖100%、增量可靠推送和聚合发送拦截证据，另行授权切换。
