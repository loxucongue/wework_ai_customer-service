...
门店目录只在 Router 明确要求门店事实后加载；城市/区县列表候选不超过 6 家时全部交付门店卡，超过 6 家时保留完整候选并让 Reply 按“门店名 + 区县”输出文字清单。精确位置的最近门店排序仍使用有限候选，不把全部远近门店当作同级推荐。客户已经收到同一家门店卡后，再问停车、营业时间或楼层时复用已确认门店事实，不重复卡片和完整地址；未预约且没有新卡点时，答清后应自然连接预约登记，而不是只问没有说明用途的到店时间。
