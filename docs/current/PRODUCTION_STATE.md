...
- owner: operations
- verified_at: `2026-09-07T00:08:57+08:00`
- source_of_truth: 服务器现场核验；本页只在上述时刻有效

## 当前后端 release

- release: `ai-paths-unified-20260907-bi-4a926b66`
- git commit: `4a926b6618d87464d63e3419e3a22695223c5e93`
...
| 管理前端 | `ai-paths-frontend.service` | active/running | `frontend-20260907-bi-4a926b66`，本机监听 5000，`/analytics/sales` 返回 HTTP 200 |
...
- 后端 `/opt/ai-paths/previous` 与 Reply `/opt/ai-paths-v3/previous` 均指向已验证的上一 clean release `ai-paths-unified-20260907-bi-54a58a58`。
